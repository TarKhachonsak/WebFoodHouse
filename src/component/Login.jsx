            ...
            <div className="bg-white rounded-3xl shadow-lg overflow-hidden md:flex w-full md:max-w-4xl z-20">
                ...
                <div className="w-full md:w-1/2 px-6 py-10">
                    ...
                    <form>
                        ...
                        <button className="w-full bg-[#FFF346] text-black font-bold py-2 rounded-lg hover:bg-yellow-300 transition duration-300">Login</button>

                        <button className="mt-5 w-full bg-[#5CD9FF] hover:bg-[#4AC4E6] text-black font-bold py-2 rounded-lg  transition duration-300">Register</button>
